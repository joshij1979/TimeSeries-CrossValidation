...
fit2 = stl(tSerie, s.window=24); plot(fit2)
# recurrence plot of season
recurr(fit2$time.series[,1], m=2, d=1)
# recurrence plot of trend
recurr(fit2$time.series[,2], m=2, d=1)
# recurrence plot of remainder
recurr(fit2$time.series[,3], m=2, d=1)
